   ...
   try{
     ...
     $errormessage = Array();
      ...
      if(isset($_POST['customerName'])||
		...
		// To upload File to the directory named 'files' 
                ...
                <div class="main">
                    ...
                    <form name="frmNewsletter" id="frmNewsletter" method="post" action="contact.php" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>Name:</td>
                                <td><input type="text" name="customerName" id="customerName" placeholder="Dikshit Dikshit" size='40'>
                                <?php 
                            ...
                            <tr>
                                <td>Phone Number:</td>
                                <td><input type="text" name="phoneNumber" id="phoneNumber" size='40' placeholder="873-288-2876" value='<?php
                            ...
                            <tr>
                                <td>Email Address:</td>
                                <td><input type="text" name="emailAddress" id="emailAddress" placeholder="diks0005@algonquinlive.com" size='40'><?php 
